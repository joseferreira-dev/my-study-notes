...
Neste capítulo, dissecamos os três pilares que sustentam toda a criptografia moderna, compreendendo as ferramentas e os paradigmas utilizados para proteger a informação em seus mais diversos contextos. Deixamos para trás os conceitos abstratos e mergulhamos na arquitetura, no funcionamento e nas aplicações práticas dos algoritmos que formam a espinha dorsal da segurança digital.

Iniciamos nossa jornada pela **Criptografia Simétrica**, o paradigma da chave única. Vimos sua principal força — a velocidade e a eficiência computacional — e seu calcanhar de Aquiles: o complexo problema da distribuição segura de chaves. Percorremos sua evolução histórica, desde o influente, porém obsoleto, **DES** e sua solução de transição, o **3DES**, até chegarmos ao padrão-ouro da atualidade, o **AES**. Exploramos também alternativas importantes, como as cifras da família **RC**, o robusto **Twofish** e a moderna cifra de fluxo **ChaCha20**, compreendendo que a escolha do algoritmo depende do balanço entre segurança, desempenho e caso de uso.

Em seguida, exploramos a revolução conceitual da **Criptografia Assimétrica**, o paradigma do par de chaves pública e privada. Entendemos como sua engenhosa matemática resolveu o problema da troca de chaves e abriu as portas para duas funcionalidades cruciais e distintas: a **confidencialidade**, ao se cifrar com a chave pública do destinatário, e a **autenticidade** (ou assinatura digital), ao se assinar com a chave privada do emissor. Detalhamos o funcionamento de algoritmos fundamentais como o **Diffie-Hellman**, para o acordo de chaves, o onipresente **RSA**, e a moderna e eficiente **Criptografia de Curva Elíptica (ECC)**.

Por fim, analisamos o terceiro pilar: as **Funções de Hash**. Compreendemos sua natureza unidirecional e sua capacidade de criar uma "impressão digital" de tamanho fixo para qualquer dado. Vimos suas aplicações indispensáveis na verificação de **integridade** de arquivos, no **armazenamento seguro de senhas** e como um componente essencial das **assinaturas digitais**. Analisamos também as ameaças, como as colisões e o **Ataque de Aniversário**, que levaram à obsolescência de algoritmos como o MD5 e o SHA-1 e à adoção dos padrões seguros atuais, o SHA-2 e o SHA-3.

Concluímos, portanto, que a criptografia simétrica, a assimétrica e as funções de hash não são tecnologias concorrentes, mas sim ferramentas complementares. Em sistemas do mundo real, elas são utilizadas em conjunto, em um modelo de **criptografia híbrida**, para construir protocolos seguros, rápidos e robustos. O domínio desses três pilares é a base para a compreensão de tópicos mais avançados, como a Infraestrutura de Chave Pública (PKI) e a segurança das comunicações na internet.