...
O pilar da Política de Transparência e Acesso à Informação representa uma evolução do conceito de transparência: a política de **Dados Abertos**. Enquanto a transparência ativa tradicional se foca na divulgação de informações em formatos legíveis para humanos (como relatórios em PDF), a política de dados abertos foca na publicação de dados em formatos que possam ser lidos e processados por computadores.

O Decreto nº 11.529/2023 ressalta que a **CGU**, enquanto órgão central do Sitai, também é responsável pela gestão do **Portal Brasileiro de Dados Abertos**.

A definição formal de Dados Abertos é dada pelo Decreto nº 8.777/2016:

> Dados Abertos consistem em “dados acessíveis ao público, representados em meio digital, estruturados em **formato aberto**, **processáveis por máquina**, referenciados na internet e disponibilizados sob **licença aberta que permita sua livre utilização**, consumo ou cruzamento, limitando-se a creditar a autoria ou a fonte”.

Em síntese, a política de dados abertos representa uma forma de publicação de dados em formatos reutilizáveis, com três grandes objetivos:

1. **Aumentar a Transparência e o Controle Social:** Ao disponibilizar bases de dados completas, pesquisadores e a sociedade civil organizada podem realizar análises aprofundadas e fiscalizar a gestão pública com um nível de detalhe que seria impossível a partir de relatórios estáticos.
2. **Fomentar a Participação Política:** Cidadãos e grupos podem utilizar os dados para embasar suas reivindicações e participar de forma mais qualificada nos debates sobre políticas públicas.
3. **Gerar Inovação e Negócios:** A livre utilização dos dados permite que empresas, startups e desenvolvedores criem novos produtos e serviços de valor para a sociedade. Um exemplo clássico é o desenvolvimento de aplicativos de transporte que utilizam dados de localização de ônibus em tempo real, fornecidos pelo poder público.

#### Portal Brasileiro de Dados Abertos

O **Portal Brasileiro de Dados Abertos (dados.gov.br)** é a ferramenta central desta política. Sua finalidade é prover um **catálogo de referência** para a busca e o acesso aos dados públicos e aos seus **metadados** (as informações que descrevem os dados, como seu formato, sua origem, frequência de atualização, etc.), além de informações, aplicativos e serviços relacionados. Ele funciona como um "Google" dos dados do governo, centralizando e facilitando a localização das bases de dados que são publicadas pelos diversos órgãos federais.

### Transparência Passiva

Fechando a tríade da Política de Transparência, o decreto detalha o funcionamento da **transparência passiva**. Conforme já estudado no capítulo anterior, esta modalidade corresponde ao dever do Estado de responder a pedidos de acesso à informação específicos, formulados por qualquer cidadão.

O Decreto nº 11.529/2023 determina que a transparência passiva será realizada por meio de um **sistema eletrônico específico** para o registro e o atendimento desses pedidos. No âmbito do Poder Executivo Federal, este sistema é a **Plataforma Integrada de Ouvidoria e Acesso à Informação (Fala.BR)**.

A gestão deste sistema eletrônico centralizado é de competência da **Controladoria-Geral da União (CGU)**.

#### A Transparência sobre a Transparência: A Publicação dos Pedidos e Respostas

O decreto estabelece um importante mecanismo de "meta-transparência", ou seja, de transparência sobre o próprio processo de transparência. Conforme o art. 17, os **pedidos de acesso à informação** registrados no sistema eletrônico e suas **respectivas respostas** serão, por padrão, **disponibilizados para consulta aberta na internet**.

Essa medida tem múltiplos benefícios:

- **Eficiência:** Permite que outros cidadãos com a mesma dúvida encontrem a resposta já fornecida, evitando a duplicidade de pedidos.
- **Controle Social:** Permite que a sociedade fiscalize a qualidade, a tempestividade e o teor das respostas fornecidas pelos órgãos públicos.
- **Base de Conhecimento:** Cria um vasto repositório público de informações sobre a Administração Pública.

Para garantir o direito à privacidade, a norma estabelece duas salvaguardas importantes:

1. A divulgação dos pedidos e respostas **não incluirá os dados pessoais do solicitante** original.
2. Os órgãos responsáveis pelo tratamento do pedido deverão indicar a existência de dados pessoais de terceiros ou de informações sigilosas na resposta, para que estes trechos sejam devidamente omitidos na publicação.

#### A Responsabilidade em Casos de Transferência de Competência

O art. 18 do decreto estabelece uma regra clara sobre a responsabilidade pela transparência quando há delegação de atividades entre órgãos: a responsabilidade acompanha a competência.

Os órgãos que receberem atribuições por força de transferência de competência de outros órgãos ficam responsáveis pelo atendimento às solicitações de acesso à informação e pela transparência ativa dos atos praticados no exercício dessa competência.

- **Exemplo:** Se o Ministério A delega ao Ministério B a gestão de um programa social, caberá ao Ministério B (que está executando a política) responder aos pedidos de informação e publicar os dados sobre a execução do referido programa.

### Resumo da Política de Transparência e Acesso à Informação

O esquema a seguir resume os três pilares da política e seus principais mecanismos:

<div align="center">
<img width="700px" src="./img/decreto-11529-politica.png">
</div>

## Considerações Finais

Ao longo deste capítulo, analisamos o **Decreto nº 11.529, de 2023**, um normativo que representa um significativo avanço e amadurecimento na arquitetura de governança da Administração Pública Federal. Sua principal inovação foi a de unir, sob uma mesma estrutura sistêmica, três agendas que, embora relacionadas, eram muitas vezes tratadas de forma separada: a **Integridade**, a **Transparência** e o **Acesso à Informação**.

Vimos a criação do **Sistema de Integridade, Transparência e Acesso à Informação (Sitai)**, a estrutura institucional desenhada para garantir a coordenação e a padronização dessas políticas. Compreendemos a clara divisão de papéis entre a **Controladoria-Gral da União (CGU)**, como órgão central estratégico e normatizador, e as **unidades setoriais** em cada órgão, como as executoras locais da política.

Aprofundamos nos conceitos de **Programa de Integridade**, como a estratégia permanente de cada órgão, e de **Plano de Integridade**, como o instrumento de ação concreto e periódico, que traduz os princípios em medidas, metas e prazos. Entendemos que as diversas **funções de integridade** (Ouvidoria, Corregedoria, Ética, etc.) são os braços operacionais que sustentam esse sistema.

Estudamos também a **Política de Transparência e Acesso à Informação**, que consolida e detalha a aplicação da LAI no Executivo Federal. Analisamos seus três pilares: uma **transparência passiva**, centralizada e mais eficiente; uma **transparência ativa**, robustecida pelo Portal da Transparência; e um compromisso com o futuro, por meio da política de **Dados Abertos**, que potencializa a inovação e o controle social.

O estudo deste decreto é, portanto, fundamental para a compreensão do estágio atual da gestão pública no Brasil. Ele demonstra um movimento claro em direção a uma administração mais proativa, sistêmica e integrada no que tange à ética e à abertura. Para o futuro servidor, este normativo não é apenas mais uma regra; é o projeto da administração íntegra, transparente e responsável da qual ele fará parte e para a qual deverá contribuir.