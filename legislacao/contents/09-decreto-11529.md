...
O terceiro pilar da Política de Transparência e Acesso à Informação representa uma evolução do conceito de transparência: a política de **Dados Abertos**. Enquanto a transparência ativa tradicional se foca na divulgação de informações em formatos legíveis para humanos (como relatórios em PDF), a política de dados abertos foca na publicação de dados em formatos que possam ser lidos e processados por computadores.
