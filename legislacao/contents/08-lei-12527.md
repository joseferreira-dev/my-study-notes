...
### Aplicação a Entidades Privadas
...
<div align="center">
<img width="550px" src="./img/lei-12527-transparencia-ativa-e-passiva.png">
</div>
...
#### Transparência Ativa: Dever de Publicar Informações
...
<div align="center">
<img width="650px" src="./img/lei-12527-transparencia-ativa.png">
</div>
...
> **Ponto de Destaque: Divulgação da Remuneração dos Servidores**
> 
...
### Acesso à Informação em Detalhe
...
> **Ponto de Atenção: Acesso a Processos em Andamento**
> 
...
#### Deveres dos Órgãos Públicos na Gestão da Informação (Art. 6º)
...
#### Instrumentos para Assegurar o Acesso (Art. 9º)
...
## Procedimento de Acesso à Informação (Transparência Passiva)
...
> **PONTO FUNDAMENTAL: Vedação à Exigência de Motivação**
> 
...
#### Prazos e as Respostas Possíveis
...
### Recursos Contra a Negativa de Acesso
...
#### Processo Recursal no Poder Executivo Federal
...
#### Processo Recursal nos Demais Poderes e Entes
...
> **PONTO FUNDAMENTAL: Tutela de Direitos Fundamentais**
> 
...
<div align="center">
<img width="600px" src="./img/lei-12527-hipoteses-de-sigilo.png">
</div>
...
<div align="center">
<img width="280px" src="./img/lei-12527-graus-de-sigilo.png">
</div>
...
Estes prazos são **máximos**, o que significa que a Administração pode estabelecer um prazo de sigilo inferior. É possível, inclusive, vincular o fim do sigilo a um evento futuro (como o término de uma operação militar), desde que este evento ocorra antes do transcurso do prazo máximo de classificação.
...
#### A) Competência para a Classificação
...
- **Grau Ultrassecreto:** Apenas o Presidente da República, o Vice-Presidente, os Ministros de Estado e autoridades com o mesmo status, os Comandantes das Forças Armadas e os chefes de missões diplomáticas e consulares permanentes no exterior.
...
> **Ponto de Atenção: Delegação da Competência de Classificação**
> 
...
#### C) Controle das Informações Classificadas
...
#### D) Reavaliação da Classificação
...
> **Ponto de Atenção: Prazo de Sigilo de 100 Anos**
> 
...
#### Exceções à Regra do Sigilo Pessoal
...
### Responsabilidade dos Agentes Públicos e Militares
...
Após o devido processo legal, que deve assegurar o contraditório e a ampla defesa, as condutas acima descritas serão consideradas, para fins de punição:
...
### Responsabilidade das Pessoas Físicas e Entidades Privadas
