...
<div align="center">
<img width="600px" src="./img/lei-13709-objetivos.png">
</div>
...
<div align="center">
<img width="700px" src="./img/lei-13709-tratamento-de-dados-pessoais.png">
</div>
...
<div align="center">
<img width="700px" src="./img/lei-13709-tratamento-de-dados-sensiveis.png">
</div>
...
<div align="center">
<img width="700px" src="./img/lei-13709-dados-de-criancas-e-adolescentes.png">
</div>
...
<div align="center">
<img width="700px" src="./img/lei-13709-termino-do-tratamento-sintese.png">
</div>
...
<div align="center">
<img width="700px" src="./img/lei-13709-direitos-do-titular.png">
</div>
...
<div align="center">
<img width="700px" src="./img/lei-13709-compartilhamento-de-dados.png">
</div>
...
<div align="center">
<img width="700px" src="./img/lei-13709-transferencia-internacional-de-dados.png">
</div>
...
<div align="center">
<img width="700px" src="./img/lei-13709-responsabilidade-e-ressarcimento.png">
</div>
...
<div align="center">
<img width="700px" src="./img/lei-13709-sancoes-aplicaveis.png">
</div>
...
O Conselho Nacional de Proteção de Dados Pessoais e da Privacidade (CNPD) é um órgão multissetorial, de natureza consultiva, que integra a estrutura da ANPD. Seu principal objetivo é servir como um fórum de debate entre o governo e a sociedade civil, garantindo a participação social na formulação das políticas de proteção de dados.

O CNPD será composto por **23 representantes**, titulares e suplentes, dos seguintes órgãos e setores (art. 58-A):

**Representantes Governamentais (10):**

> I - 5 (cinco) do Poder Executivo federal;
> II - 1 (um) do Senado Federal;
> III - 1 (um) da Câmara dos Deputados;
> IV - 1 (um) do Conselho Nacional de Justiça (CNJ);
> V - 1 (um) do Conselho Nacional do Ministério Público (CNMP);
> VI - 1 (um) do Comitê Gestor da Internet no Brasil (CGI.br);
...
**Representantes de Instituições Científicas (3):**

> VIII - 3 (três) de instituições científicas, tecnológicas e de inovação;

**Representantes do Setor Produtivo (5):**
...
**Representantes do Setor Laboral (2):**

> XI - 2 (dois) de entidades representativas do setor laboral (trabalhadores).

Os representantes serão designados por ato do Presidente da República, permitida a delegação (§ 1º), observando-se o seguinte:

- **Representantes Governamentais (I a VI):** Serão indicados pelos titulares dos respectivos órgãos/entidades.
- **Representantes Não Governamentais (VII a XI):** Serão indicados na forma de regulamento, terão **mandato de 2 (dois) anos**, permitida **1 (uma) recondução**, e não poderão ser membros do Comitê Gestor da Internet no Brasil (CGI.br) (para evitar sobreposição).

A participação no CNPD será considerada prestação de **serviço público relevante, não remunerada**.

O diagrama a seguir compara a estrutura do órgão executivo (Conselho Diretor da ANPD) com a do órgão consultivo (CNPD):

<div align="center">
<img width="700px" src="./img/lei-13709-cnpd.png">
</div>

### Competências do CNPD

Sendo um órgão consultivo e de assessoramento, compete ao Conselho Nacional de Proteção de Dados Pessoais e da Privacidade (art. 58-B):
...
<div align="center">
<img width="700px" src="./img/lei-13709-cnpd-sintese.png">
</div>

## Regras Finais

Antes de encerrar, vale a pena comentarmos as disposições finais da LGPD, tratadas a partir de seu art. 61.

- **Notificação de Empresa Estrangeira (Art. 61):** A empresa estrangeira (que trata dados de brasileiros, por exemplo) será notificada e intimada de todos os atos processuais da LGPD (ex: uma fiscalização ou sanção da ANPD) na pessoa do agente ou representante ou pessoa responsável por sua filial, agência, sucursal, estabelecimento ou escritório instalado no Brasil, independentemente de procuração.
- **Dados da Educação (Art. 62):** Para atender especificamente à área da educação, a ANPD e o Inep (Instituto Nacional de Estudos e Pesquisas Educacionais Anísio Teixeira) editarão regulamentos específicos para o acesso a dados tratados pela União para o cumprimento da Lei de Diretrizes e Bases da Educação (LDB) e aos referentes ao Sistema Nacional de Avaliação da Educação Superior (Sinaes).
- **Adequação de Bancos de Dados Antigos (Art. 63):** A ANPD estabelecerá normas sobre a **adequação progressiva** de bancos de dados que já existiam antes da entrada em vigor da LGPD, considerando a complexidade das operações de tratamento e a natureza dos dados.
- **Cláusula de Abertura (Art. 64):** Os direitos e princípios expressos na LGPD **não excluem outros** previstos no ordenamento jurídico pátrio relacionados à matéria (como o Código de Defesa do Consumidor ou o Marco Civil da Internet) ou nos tratados internacionais em que o Brasil seja parte.

## Considerações Finais

Ao longo deste capítulo, exploramos a **Lei Geral de Proteção de Dados Pessoais (LGPD)**, um dos diplomas legislativos mais transformadores da história recente do Brasil. Seu impacto vai muito além do direito digital, reconfigurando as relações entre cidadãos, empresas e o Poder Público na sociedade da informação.

A LGPD nasceu da necessidade de proteger direitos fundamentais (como a **privacidade** e a **autodeterminação informativa**) em um mundo onde os dados pessoais se tornaram o ativo mais valioso. Vimos que ela se fundamenta não apenas na proteção do indivíduo, mas também na garantia da **livre iniciativa** e da **inovação**, buscando criar um ambiente de segurança jurídica para o desenvolvimento econômico.

Estudamos os 10 **princípios** (art. 6º) que regem todo o tratamento de dados, com destaque para a **Finalidade** (o tratamento deve ter um propósito específico), a **Necessidade** (coleta mínima de dados) e a **Responsabilização e Prestação de Contas** (o dever de provar que está em conformidade).

Analisamos o coração da lei: as **bases legais** (art. 7º e 11). Compreendemos que o **consentimento**, embora seja a base legal mais famosa, não é a única. O tratamento pode ser lícito com base em obrigações legais, execução de contratos, legítimo interesse, entre outras, sendo o rol para **dados pessoais sensíveis** (art. 11) significativamente mais restrito.

Detalhamos os papéis dos agentes de tratamento – o **Controlador** (quem toma as decisões) e o **Operador** (quem executa) – e a figura central do **Encarregado (DPO)**, que atua como a ponte entre o titular, a empresa e a autoridade.

Analisamos, também, as regras específicas para o **Poder Público**, que deve equilibrar as exigências da LGPD com o dever de transparência da Lei de Acesso à Informação (LAI), e as regras rigorosas para o compartilhamento de dados com entes privados.

Por fim, abordamos o braço fiscalizador da lei: a **Autoridade Nacional de Proteção de Dados (ANPD)**. Vimos sua estrutura como autarquia, suas vastas competências normativas, fiscalizatórias e sancionatórias, incluindo o pesado rol de **sanções** do art. 52, que vão desde a advertência até multas milionárias e a proibição do tratamento de dados.

O estudo da LGPD é, portanto, o estudo de uma nova cultura de privacidade e segurança. Para o cidadão, ela representa a retomada do controle sobre suas próprias informações; para as organizações públicas e privadas, ela impõe o dever de tratar a privacidade como um pilar de suas operações.