...
<div align="center">
<img width="650px" src="./img/lei-9784-principio-da-publicidade.png">
</div>
...
Quanto à competência para apreciar o recurso, é fundamental recordar o que foi visto anteriormente: a **decisão de recursos administrativos** é uma das três matérias **indelegáveis** no âmbito da Lei 9.784/1999 (art. 13, II).

Além disso, ante a necessidade de se assegurar o duplo grau de jurisdição no processo administrativo, é importante diferenciarmos as situações em que o recurso é apreciado pela via hierárquica (recurso hierárquico).

Maria Sylvia Zanella Di Pietro define o recurso hierárquico, como este previsto na Lei 9.784/1999, como sendo o “pedido de reexame do ato dirigido à autoridade superior à que proferiu o ato”. Como havíamos adiantado, ele poderá ser **próprio** ou **impróprio**.

- **Recurso Hierárquico Próprio:** É o modelo padrão. É dirigido à autoridade imediatamente superior **dentro do mesmo órgão** (na mesma estrutura hierárquica) em que o ato foi praticado. O recurso hierárquico próprio decorre da própria existência da hierarquia; por este motivo, ele independe de previsão legal expressa. O simples fato de existir uma chefia superior já garante o direito de pedir a ela a revisão do ato do subordinado.
- **Recurso Hierárquico Impróprio:** É a exceção. É “dirigido a autoridade de **outro órgão** não integrado na mesma hierarquia daquele que proferiu o ato”. Como não há hierarquia entre a autoridade que irá apreciar o recurso e aquela que proferiu a decisão, o recurso leva o nome de impróprio. A decorrência mais importante da ausência de hierarquia é que esta modalidade somente será cabível se estiver **expressamente prevista em lei**, pois um órgão não pode, por regra, interferir nas decisões de outro.
    - O exemplo clássico do hierárquico impróprio consiste no recurso contra ato praticado por dirigente de uma Autarquia (ex: o Presidente do INSS), o qual é interposto perante o Ministério a que a autarquia é vinculada (ex: o Ministro da Previdência Social). Entre eles não há hierarquia, mas sim **vinculação** (controle finalístico ou supervisão ministerial).
    - Outro exemplo consiste no recurso interposto perante o Conselho de Contribuintes – como o CARF (Conselho Administrativo de Recursos Fiscais) –, contra um ato de um Auditor-Fiscal da Receita Federal. O CARF é um órgão colegiado, paritário e distinto da Receita Federal, que só julga esses recursos por expressa previsão legal.

Em síntese:

|**recurso hierárquico próprio**|**recurso hierárquico impróprio**|
|---|---|
|dirigido à autoridade imediatamente superior à que praticou o ato (dentro do mesmo órgão)|dirigido a autoridade de outro órgão (em outra estrutura organizacional)|
|não depende de previsão legal|depende de previsão legal expressa|

#### Efeito Suspensivo do Recurso

Como regra geral, a interposição de recurso administrativo **não suspende automaticamente** os efeitos da decisão recorrida. Em outras palavras, o recurso administrativo, como regra geral, **não tem efeito suspensivo** (art. 61, _caput_).

Ele possui apenas **efeito devolutivo**.

- **Efeito Devolutivo (Regra):** Significa que a matéria é "devolvida" à Administração para reexame por uma autoridade superior. Contudo, enquanto o recurso é julgado, a decisão original continua válida e produzindo seus efeitos.
    - _Exemplo:_ Um fiscal aplica uma multa de R$ 10.000,00 a uma empresa. A empresa recorre. Se o recurso tiver apenas efeito devolutivo, a empresa deve pagar a multa (ou será inscrita em dívida ativa) _enquanto_ o recurso tramita.

O recurso poderá ter **efeito suspensivo**, todavia, se houver "justo receio de prejuízo de difícil ou incerta reparação" decorrente da execução imediata da decisão. Neste caso, tanto a autoridade que emitiu a decisão recorrida (no juízo de reconsideração) como a autoridade imediatamente superior (ao receber o recurso) poderão, de ofício ou a pedido, conceder o efeito suspensivo ao recurso (art. 61, parágrafo único).

- _Exemplo:_ No caso da multa de R$ 10.000,00, se a empresa provar que o pagamento imediato a levará à falência (prejuízo de difícil reparação), a autoridade poderá conceder o efeito suspensivo. A cobrança da multa ficará, então, "congelada" até a decisão final do recurso.

#### Prazos

A legislação prevê prazos distintos para (i) a interposição do recurso pelo cidadão e (ii) a sua apreciação pela Administração.

1. **Prazo de Interposição (do Interessado):** O prazo para interposição do recurso é de 10 (dez) dias, contados a partir da ciência da decisão administrativa ou da sua divulgação oficial (art. 59, caput). Caso o prazo não seja obedecido (ex: o interessado recorre no 11º dia), o recurso não será conhecido (será liminarmente indeferido por intempestividade). Por isso, este prazo é considerado preclusivo (ou “prazo próprio”), pois a perda do prazo gera a perda do direito de recorrer (preclusão temporal).
2. **Prazo de Decisão (da Administração):** A Administração, a seu turno, possui no máximo 30 (trinta) dias para decidir o recurso, contados a partir do recebimento dos autos pelo órgão competente (art. 59, § 1º). Este prazo, todavia, é considerado um "prazo impróprio". Isso significa que, caso a Administração descumpra o prazo e decida apenas no 40º dia, a decisão continua válida; o processo não é anulado pelo atraso. O descumprimento do prazo impróprio não gera a nulidade do ato, embora possa gerar a responsabilização do servidor omisso e configure uma violação ao direito à razoável duração do processo.

#### Legitimados

O art. 58 da Lei 9.784/1999 prevê as categorias de legitimados para interpor recursos administrativos. Logicamente, são os mesmos legitimados a serem considerados "interessados" no processo (vistos no art. 9º):

<div align="center">
<img width="500px" src="./img/lei-9784-legitimados.png">
</div>

#### Não Conhecimento do Recurso

O "não conhecimento" é uma decisão processual preliminar. Antes de analisar o mérito (se o recorrente tem ou não razão), a autoridade faz um juízo de admissibilidade, verificando se o recurso cumpre os requisitos mínimos para ser aceito.

Nos termos do art. 63, o recurso **não será conhecido** (ou seja, será liminarmente rejeitado) nas seguintes situações:

<div align="center">
<img width="700px" src="./img/lei-9784-nao-conhecimento-recurso.png">
</div>

1. **Fora do prazo (Intempestivo):** Se o prazo de 10 dias (art. 59) não for cumprido.
2. **Perante órgão incompetente:** Se o interessado protocolar o recurso no órgão errado.
3. **Por quem não seja legitimado:** Se o recorrente não for uma das partes legítimas (art. 58).
4. **Após exaurida a esfera administrativa:** Se o processo já tiver chegado na 3ª e última instância administrativa (art. 57).

O recurso que não é conhecido não chega a ser processado pela Administração, havendo um "arquivamento sumário" do pedido.

A lei, no entanto, prevê duas proteções ao administrado, em linha com o Princípio do Informalismo:

- **Recurso em Órgão Incompetente (Art. 63, § 1º):** Se o recurso for interposto perante órgão incompetente por erro do cidadão, a autoridade que o recebeu deve indicar ao administrado quem é a autoridade competente, e será **devolvido o prazo** para o recurso. O erro de protocolo não pode penalizar o cidadão.
- **Revisão de Ofício (Art. 63, § 2º):** Mesmo que o recurso não seja conhecido (ex: por estar fora do prazo), se a autoridade, ao ler o recurso, perceber que a decisão original era **flagrantemente ilegal**, ela pode (e deve), em nome do Princípio da Autotutela e da Verdade Material, rever de ofício o ato ilegal, desde que não tenha ocorrido a preclusão administrativa (como a decadência de 5 anos do art. 54).

#### Mérito do Recurso (Julgamento)

Uma vez conhecido o recurso (ou seja, admitido seu processamento), terá lugar a análise do seu mérito. Nesta etapa, a autoridade superior poderá confirmar, modificar, anular ou revogar, total ou parcialmente, a decisão recorrida, se a matéria for de sua competência (art. 64, _caput_).

A decisão do recurso, conforme o art. 50, V, deve ser obrigatoriamente **motivada**.

##### A Possibilidade de 'Reformatio in Pejus' (Agravamento da Situação)

A Lei 9.784/1999, diferentemente do processo penal, autoriza expressamente o agravamento da situação do recorrente. Este fenômeno é conhecido como **_reformatio in pejus_** (reforma para pior).

- **Exemplo:** Determinado cidadão recebeu uma multa da fiscalização sanitária federal no valor de R$ 10 mil. Irresignado, o administrado interpõe recurso. A autoridade superior, ao reanalisar o processo, percebe que, pelos fatos apurados, a irregularidade era mais grave e que o valor correto da multa, segundo a lei, seria de R$ 20 mil. Nos termos da Lei 9.784/1999, a autoridade superior pode **agravar** a sanção, aumentando a multa para R$ 20 mil, mesmo que isso tenha sido provocado pelo recurso do próprio infrator.

Contudo, para que o agravamento seja válido, a lei impõe uma condição fundamental em respeito ao contraditório:
...
Ou seja, antes de agravar a pena, a autoridade superior deve "abrir prazo" (intimar) para que o recorrente se defenda especificamente da possibilidade de agravamento.

#### Revisão do Processo

Além do recurso (que tem prazo e contesta a decisão original), a lei prevê um segundo instrumento para impugnar decisões: a **revisão do processo**, regulamentada no art. 65.

A revisão, diferentemente do recurso, não é uma "instância" normal. É uma ação excepcional para corrigir injustiças em **processos que já aplicaram sanções** e que, em tese, já estariam encerrados.

O fundamento da revisão é extremamente restritivo: ela só cabe quando **surgirem fatos novos ou circunstâncias relevantes** suscetíveis de justificar a inadequação da sanção aplicada. Não se trata de uma simples discordância da decisão, mas da descoberta de uma prova nova que muda o cenário fático.

> **Art. 65.** Os processos administrativos de que resultem sanções poderão ser revistos, **a qualquer tempo**, a pedido ou de ofício, quando surgirem fatos novos ou circunstâncias relevantes suscetíveis de justificar a inadequação da sanção aplicada.

##### Revisão vs. Recurso

A revisão possui duas características marcantes que a diferenciam frontalmente do recurso:

1. **Prazo:** O recurso tem prazo preclusivo de 10 dias. A revisão pode ser pedida **a qualquer tempo**, mesmo anos após o fim do processo.
2. **Vedação à 'Reformatio in Pejus':** No recurso, a pena pode ser agravada. Na revisão, a lei proíbe expressamente o agravamento:

> **Art. 65, parágrafo único.** Da revisão do processo **não poderá resultar agravamento da sanção.**

A revisão, portanto, é um instrumento exclusivo em favor do punido, destinado a corrigir erros fáticos com base em novas provas, não podendo ser usada pela Administração para piorar a sanção já aplicada.

|**Revisão**|**Recurso**|
|---|---|
|Não se sujeita à prazo (a qualquer tempo)|Prazo preclusivo (regra: 10 dias)|
|**Fundamento:** Fatos novos que justifiquem inadequação da **sanção**|**Fundamento:** Amplo (mérito ou legalidade)|
|**NÃO pode** resultar agravamento da sanção|**PODE** resultar agravamento (_reformatio in pejus_)|

##### Síntese dos Recursos Administrativos

O mapa mental a seguir sintetiza os principais aspectos dos recursos administrativos na Lei nº 9.784/1999:

<div align="center">
<img width="700px" src="./img/lei-9784-recurso-administrativo.png">
</div>

### Contagem dos Prazos Processuais

Os artigos 66 e 67 da Lei 9.784/1999 regulamentam a forma como os prazos processuais devem ser contados, estabelecendo regras claras para o início, o decurso e o vencimento, visando a garantir a segurança jurídica para o administrado e para a Administração.

#### Regras Gerais de Contagem (Art. 66)

A contagem dos prazos no Processo Administrativo Federal (PAF) segue regras processuais consolidadas:

1. **Termo Inicial (Início da Contagem):** Os prazos começam a correr a partir da data da **cientificação oficial**, que é o momento em que o interessado é formalmente notificado do ato (seja por intimação pessoal, postal, ou publicação oficial, conforme o caso).
2. **Forma de Contagem:** Segue-se a regra geral do direito processual, pela qual se **exclui o dia do começo e se inclui o do vencimento**.
    - _Exemplo:_ Se um interessado é cientificado de uma decisão na segunda-feira (dia do começo), o seu prazo de 10 dias para recorrer começa a contar na terça-feira (dia 1). O décimo dia será a quinta-feira da semana seguinte (dia do vencimento).
3. **Termo Final (Vencimento):** Se o vencimento do prazo cair em dia em que **não houver expediente** (como sábados, domingos e feriados) ou este for **encerrado antes do horário normal**, o prazo é automaticamente prorrogado até o **primeiro dia útil seguinte**.

#### Prazos em Dias vs. Prazos em Meses/Anos

A lei estabelece uma distinção fundamental na forma de contagem, a depender da unidade de tempo utilizada:

##### Prazos em Dias: Contagem Contínua

> **Art. 66, § 1º** Os prazos expressos em dias contam-se de **modo contínuo**.

Esta é uma das regras mais importantes e que gera maior confusão. "Modo contínuo" significa que os prazos são contados em **dias corridos** (calendário), e **não** em dias úteis.

- **Ponto de Atenção:** Esta regra **difere** daquela adotada pelo Código de Processo Civil (CPC), que determina a contagem de prazos processuais judiciais apenas em dias úteis. No Processo Administrativo Federal regido pela Lei 9.784/1999, sábados, domingos e feriados que caem _no meio_ do prazo **são contados normalmente**. A única regra que considera o dia útil é a do vencimento (o "termo final"), como visto acima.

##### Prazos em Meses ou Anos: Contagem "Data a Data"

> **Art. 66, § 2º** Os prazos fixados em meses ou anos contam-se de data a data. Se no mês do vencimento não houver o dia equivalente àquele do início do prazo, tem-se como termo o último dia do mês.

Neste caso, a contagem ignora o número de dias do mês.

- _Exemplo 1:_ Um prazo de 1 (um) mês iniciado em 15 de março vencerá em 15 de abril.
- _Exemplo 2 (Exceção):_ Um prazo de 1 (um) mês iniciado em 30 de janeiro vencerá em 28 de fevereiro (ou 29, em ano bissexto), pois fevereiro não possui o "dia equivalente" (dia 30). O prazo, neste caso, é antecipado para o último dia do mês de vencimento.

#### Suspensão dos Prazos (Art. 67)

Reforçando o caráter "contínuo" da contagem em dias, a lei estabelece que os prazos processuais, como regra, **não se suspendem**. A única exceção admitida pela lei é o **motivo de força maior**, que deve ser devidamente comprovado pelo interessado.

#### Compilação dos Principais Prazos da Lei Nº 9.784/1999

Por fim, compilando os principais prazos processuais mencionados ao longo deste capítulo, chegamos à seguinte tabela-resumo:

|**Ato processual**|**Prazo**|**Fundamento**|
|---|---|---|
|**Regra geral** (para atos sem prazo específico)|**5 dias** (prorrogável por + 5 dias)|Art. 24|
|Intimação para comparecimento|Antecedência mínima de **3 dias úteis**|Art. 26, §2º|
|Oitiva de órgão consultivo|Máximo de **15 dias** (salvo norma especial)|Art. 42|
|Manifestação do interessado (alegações finais)|**10 dias**|Art. 44|
|Decisão pela autoridade competente (pós-instrução)|**30 dias** (prorrogável por + 30 dias)|Art. 49|
|Interposição de recurso administrativo|**10 dias**|Art. 59, _caput_|
|Prazo para decisão do recurso|Máximo de **30 dias**|Art. 59, §1º|

## Considerações Finais

Ao longo deste capítulo, dissecamos a **Lei nº 9.784, de 1999**, indiscutivelmente um dos pilares do Direito Administrativo brasileiro moderno. Esta lei não é apenas um código de procedimentos; ela representa a consolidação do **devido processo legal na esfera administrativa**, estabelecendo um equilíbrio fundamental entre as prerrogativas da Administração Pública e os direitos fundamentais do administrado.

Vimos que seu âmbito de aplicação, embora focado na esfera federal (aplicando-se a todos os Poderes na função administrativa), transborda para Estados e Municípios por meio da **aplicação subsidiária**, especialmente em temas centrais como o **prazo decadencial** de cinco anos (art. 54), que se tornou um marco de **segurança jurídica** em todo o país.

A lei inicia por codificar um rol de **princípios** (art. 2º) que vão além do "LIMPE" constitucional, consagrando expressamente a **motivação**, a **razoabilidade**, a **proporcionalidade**, o **contraditório**, a **ampla defesa** e a **segurança jurídica**. Demonstramos como esses princípios se materializam em regras práticas, como o **Princípio da Oficialidade** (impulso de ofício), da **Verdade Material** (que veda a confissão ficta), do **Informalismo Moderado** (que dispensa o advogado, em regra) e da **Gratuidade**.

Analisamos o "estatuto" do cidadão perante o Estado, detalhando seus **direitos** (art. 3º) – como o acesso aos autos e a prioridade de tramitação – e seus **deveres** (art. 4º), baseados na boa-fé e na lealdade processual.

Exploramos os institutos que regem a organização do processo, como a **Competência**, sua irrenunciabilidade e as exceções da **delegação** (a regra) e da **avocação** (a exceção), bem como as matérias indelegáveis (CENoR). Estudamos os mecanismos de imparcialidade (o **impedimento** objetivo e a **suspeição** subjetiva) e as regras de **forma, tempo, lugar e prazo**, com destaque para a contagem em dias contínuos.

Revisitamos o poder de **autotutela** (art. 53), diferenciando o **dever de anular** (atos ilegais, com efeito _ex tunc_) do **poder de revogar** (atos inoportunos, com efeito _ex nunc_), e a possibilidade de **convalidação** (art. 55) dos vícios sanáveis.

Por fim, detalhamos o sistema recursal. Vimos o **recurso hierárquico** como regra (com seu juízo de reconsideração de 5 dias e prazo de 10 dias para interposição), a possibilidade de agravamento da pena (_reformatio in pejus_) e o limite de três instâncias. E o diferenciamos da **revisão** (art. 65), cabível a qualquer tempo para sanções, baseada em fatos novos e sem possibilidade de agravar a pena.

O estudo da Lei nº 9.784/1999 é, portanto, a base para a compreensão de toda a atuação processual da Administração Federal. Ela fornece as garantias, os ritos e a segurança necessários para que a busca pelo interesse público seja conduzida de forma justa, eficiente e legal.